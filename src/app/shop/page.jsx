...
const ProductCatalog = () => {
  const searchParams = useSearchParams();  // Get query params in Next.js 13+
  const cart = searchParams.get("cart") || null;
  
  console.log('category name',cart)
  ...
  useEffect(() => {
    if (cart) {
      setSelectCategory(cart);
    }
  }, [cart]);
  console.log('inside useEffect',selectCategory)
