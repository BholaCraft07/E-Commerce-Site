"use client";
import DatePickerCard from "@/component/DatePicker";
...
function Payment() {
    ...
    const { cartItems, cartTotal, setCartTotal } = useCart();
                                ...
                                <div class="mb-6 grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <span className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-9 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                                <DatePickerCard />
                                            </span>
                                        </div>
                                    </div>
